...
public class TrackerClient {
  ...
  public StorageServer getStoreStorage(TrackerServer trackerServer, String groupName) throws IOException {
    ...
    try {
      ...
      if(ClientGlobal.need_internet_2_lan) {
        // 需要内外网互联需要重新设置ip和端口
        ip_addr = ClientGlobal.storage_transfer_address_conf.split(":")[0];
        port = Integer.valueOf(ClientGlobal.storage_transfer_address_conf.split(":")[1]);
      } else {
