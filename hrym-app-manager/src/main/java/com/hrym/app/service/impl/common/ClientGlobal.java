...
package com.hrym.app.service.impl.common;
...
public class ClientGlobal {
  ...
  public static final String PROP_KEY_NEED_TRANSFORM = "fastdfs.need_internet_2_lan";
  public static final String PROP_KEY_TRANSFORM_ADDRESS = "fastdfs.storage_transfer_address_conf";
  ...
  public static final String URL_PREFIX = "fastdfs.url_prefix";
  ...
  public static String fastdfs_url_prefix = "";
  public static boolean need_internet_2_lan = false;
  public static String storage_transfer_address_conf = "";
  ...
  public static void initByProperties(Properties props) throws IOException, MyException {
    ...
    String needTransform = props.getProperty(PROP_KEY_NEED_TRANSFORM);
    if (needTransform != null && needTransform.trim().length() != 0) {
      need_internet_2_lan = Boolean.parseBoolean(needTransform);
    }

    fastdfs_url_prefix = props.getProperty(URL_PREFIX);
    storage_transfer_address_conf = props.getProperty(PROP_KEY_TRANSFORM_ADDRESS);
    if(need_internet_2_lan && storage_transfer_address_conf.indexOf(":")==-1) {
      throw new MyException("内外网互联时，需要设置sstorage_transfer_address_conf值，[ip]:[port]的格式，当前值为["+storage_transfer_address_conf+"]");
    }
