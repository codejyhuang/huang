                    ...
                    <form class="form-horizontal" role="form" id="model_from" action="">
                        ...
                        <div class="form-group">
                            ...
                            <div  style="color: #dddd00">
                                ...
                                <dl><dt style="padding-left: 110px;padding-top: 8px">除了修行专区，其他专区只能选择以下的功课类型：<dd style="padding-left: 110px;padding-top: 5px">咒语、佛号、其他课诵、经书、禅修、顶礼 </dd>
                                    </dt>
                                </dl>
                            </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 ">
                                <select class="form-control lW" name="itemId" id="itemId" onchange="return getItemContentID(value)" onclick="getItemContentID(value)"  >
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control lW" id="taskPeriod" name="taskPeriod" type="text"
                                       onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');" oninput="if(value.length>4)value=value.slice(0,4)">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control lW" id="taskTarget" name="taskTarget" value="" type="number"
                                       onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');" oninput="if(value.length>8)value=value.slice(0,8)">
                            </div>
                        </div>
