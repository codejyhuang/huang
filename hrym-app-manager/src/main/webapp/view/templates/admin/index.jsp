                                        ...
                                        <c:choose>
                                            <c:when test="${sub.menuName=='文章编辑'}">
                                                <ul class="nav nav-second-level">
                                                    <li>
                                                        <a class="J_menuItem" href="http://www.everglamming.com/textEdit/index.html">${sub.menuName}</a>
                                                    </li>
                                                </ul>
                                            </c:when>
                                            <c:otherwise>
                                                <ul class="nav nav-second-level">
                                                    <li>
                                                        <a class="J_menuItem" href="${pageContext.request.contextPath}/${sub.page}">${sub.menuName}</a>
                                                    </li>
                                                </ul>
                                            </c:otherwise>
                                        </c:choose>
