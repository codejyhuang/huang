            ...
            <div class="modal-content modal-style">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form" id="model_from"action="">
                        ...
                        <div class="form-group" id="tt2">
                            <label class="col-sm-2 control-label">父类目:</label>
                            <div class="col-sm-10">
                                <input class="form-control lW" id="focusedInput2" type="text"  placeholder="商品类目...">
                            </div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="btn">提交更改
                    </button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal -->
			...
			$("#table_list").bootstrapTable({
			    ...
			    columns: [{
                    ...
                    formatter: function (value, row) {
                    	var operateHtml = '<button class="btn btn-primary btn-xs" type="button" data-toggle="modal" data-backdrop="static" data-target="#myModal" onclick="edit(\''+row.q+'\')"><i class="fa fa-edit"></i>&nbsp;重命名</button> &nbsp;';
                    	operateHtml = operateHtml + '<button class="btn btn-danger btn-xs" type="button" onclick="del(\''+row.q+'\')"><i class="fa fa-remove"></i>&nbsp;删除</button> &nbsp;';
                        return operateHtml;
                    }
			    }]
			});
