...
public class RedisUtil {
	 ...
	 * redis过期时间,以秒为单位
	 */
	public final static int EXRP_ONE_THIRDE_HOUR = 10 * 60; //10分钟
	public final static int EXRP_HALF_HOUR = 30 * 60;
	public final static int EXRP_HOUR = 60 * 60;            //一小时
	public final static int EXRP_DAY = 60 * 60 * 24;        //一天
	public final static int EXRP_MONTH = 60 * 60 * 24 * 30;    //一个月
	public final static int EXRP_YEAR = 60 * 60 * 24 * 30 * 12;    //一年
