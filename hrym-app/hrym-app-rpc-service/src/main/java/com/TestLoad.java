...
//        }
        ...
        System.out.println("java.version=" + System.getProperty("java.version")+",time=="+System.currentTimeMillis());
...
//            }
            ...
            //http://202.104.112.185:8089/group1/M00/00/11/wKgAHVnklZyAbf0SABWJ-nDvLaI456.mp3
//            file_ids.offer("group1/M00/00/14/wKgAHVntpneAft1BAAscirodE3Y59.jpeg");
            //group1/M00/00/11/wKgAHFnts--AFBM0AAABc6AFwaU91.html

            ExecutorService pool = Executors.newFixedThreadPool(8);
            for(int i = 0;i < 200;i++) {
                file_ids.offer("group1/M00/00/11/wKgAHFnts--AFBM0AAABc6AFwaU91.html");
            }
            for (int i = 0; i < 200; i++) {
...
//            file_buff = new byte[938613];
            java.util.Arrays.fill(file_buff, (byte) 65);

            try {
                File file = new File("/Users/hong/Desktop/宝2/WechatIMG1435.jpeg");
                FileInputStream fin=new FileInputStream(file);
                file_id = client.upload_file1("",fin.available(),new UploadStream(fin,fin.available()),"jpeg",null);
        ...
        public int downloadFile(String file_id) throws Exception {
            ...
            try {
                ...
                if (errno != 0) {
                    ...
                    System.out.println("Download file success, file_id: " + file_id);
                }
                return errno;
            } catch (Exception ex) {
    ...
    public static class UploadThread extends Thread {
        ...
        public void run() {
            ...
            System.out.println("upload thread " + this.thread_index
                    ...
                    + ", success_download_count: " + TestLoad.success_download_count+",time=============="+System.currentTimeMillis());
        }
    }
...
//                while (TestLoad.upload_thread_count != 0 || file_id != null) {
                while(TestLoad.file_ids.size()>0){
