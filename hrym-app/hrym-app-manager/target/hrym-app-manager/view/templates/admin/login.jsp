...
<head>
    ...
    <link href="${pageContext.request.contextPath}/view/static/assets/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="${pageContext.request.contextPath}/view/static/assets/css/style.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/view/static/assets/css/login.css" rel="stylesheet">
    <!--[if lt IE 9]>
    ...
    <div class="signinpanel">
        <div class="row">
            <div class="col-sm-12">
                ...
                <form method="post" action="${pageContext.request.contextPath}/admin/submit" id="frm">
                    <div>
                        <h4 class="no-margins h4">慧日永明后台登录界面</h4>
                    </div>
