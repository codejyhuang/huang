...
<script>
    $(document).ready(function () {
        ...
        $("#table_list").bootstrapTable({
            ...
            //获取数据的Servlet地址
            url: "${pageContext.request.contextPath}/admin/findAllWishActivity",
            //表格显示条纹
            striped: false,
            //启动分页
            pagination: true,
            ...
            columns: [{
                ...
                formatter: function (value, row, index) {
                    if (value ==1)
                        return  operateHtml = '<button class="btn btn-danger btn-xs" type="button" onclick="s(\''+row.bannerId+'\')"><i class="fa "></i>&nbsp;中奖</button> &nbsp;';
                    else
                        return'<p>未中奖</p>'
                }
            }]
