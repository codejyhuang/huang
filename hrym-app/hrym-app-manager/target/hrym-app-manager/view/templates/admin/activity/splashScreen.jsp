                    ...
                    <div class="ibox-content" >
                        <form class="form-horizontal m-t" id="bannerForm" method="post" action="" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control layer-date" id="sts" name="sts" placeholder="YYYY-MM-DD hh:mm:ss" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control layer-date" id="ets" name="ets" placeholder="YYYY-MM-DD hh:mm:ss" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
                                    <label class="laydate-icon"></label>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">标准闪屏图片：</label>
                                <div class="col-sm-6">
                                    <input id="pic" name="pic" class="form-control" type="text" value="${list.bannerUrl}" readonly>
                                </div>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">全屏闪屏图片：</label>
                                <div class="col-sm-6">
                                    <input id="xpic" name="xpic" class="form-control" type="text" value="${list.bannerUrl}" readonly>
                                </div>
                                <div class="col-sm-3">
                                    <label class="col-sm-3 control-label">
                                        <input type="file" class="fileEdit" name="taskItemPic" class="itemPic oas-filebutton-default">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">闪屏URL：</label>
                                <div class="col-sm-8">
...
<script>
    $(document).ready(function () {
        ...
        $("#table_list").bootstrapTable({
            ...
            //获取数据的Servlet地址
            url: "${pageContext.request.contextPath}/admin/findALLSScreem",
            //表格显示条纹
            striped: false,
            //启动分页
            pagination: true,
            ...
            columns: [{
                ...
                formatter: function (value, row, index) {
                    var operateHtml = '<button class="btn btn-primary btn-xs" data-toggle="modal" data-backdrop="static" data-target="#myModal" type="button"  onclick="editBanner(\''+row.id+'\')"><i class="fa fa-edit"></i>&nbsp;修改</button> &nbsp;';
    ...
    <%--function editBanner(id) {--%>
        <%--layer.open({--%>
            ...
            <%--shade: false,--%>
            <%--area: ['893px', '500px'],--%>
            <%--content: '${pageContext.request.contextPath}/admin/findSScreemById?id='+id,--%>
            <%--end: function (index) {--%>
    ...
    function editBanner(id) {
        ...
        $.ajax({
            ...
            dataType:"json",
            contentType:"application/json",
            url :"${pageContext.request.contextPath}/admin/findSScreemById/",
            data:{"id":id},
...
//                $("#itemId").append("<option name='itemId'  value="+msg.rows.itemId+">"+msg.rows.itemName+"</option>" );
    ...
    function del(id){
        layer.confirm('确定删除吗?', {icon: 3, title:'提示'}, function(index){
            ...
            $.ajax({
                ...
                dataType: "json",
                contentType: "application/json",
                url:"${pageContext.request.contextPath}/admin/deleteSScreem/",
                data:{"id":id},
                success: function(msg){
    ...
    $(document).on("click",".insertAllBanner",function(){
        ...
        if (id.value.length>0){
            url="${pageContext.request.contextPath}/admin/updateSScreem"
        }else {
            url="${pageContext.request.contextPath}/admin/insertSScreem"
        }
