    ...
    <script>
        $(document).ready(function () {
			...
			$("#table_list").bootstrapTable({
			    ...
			    //获取数据的Servlet地址
			    url: "${pageContext.request.contextPath}/admin/findAllUser",
			    //表格显示条纹
			    striped: false,
			    //启动分页
			    pagination: true,
               ...
               // height: tableHeight(),
			    ...
			    columns: [{
                    ...
                    formatter: function (value, row, index) {
                    	var operateHtml = '<button class="btn btn-primary btn-xs" type="button" onclick="userList(\''+row.uuid+'\')"><i class="fa fa-edit"></i>&nbsp;详情</button> &nbsp;';
                        return operateHtml;
                    }
			    }]
			});
