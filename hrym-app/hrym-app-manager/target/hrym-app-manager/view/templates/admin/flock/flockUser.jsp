    ...
    <script>
        $(document).ready(function () {
			...
			$("#table_list").bootstrapTable({
			    ...
			    //获取数据的Servlet地址
			    url: "${pageContext.request.contextPath}/admin/listFlockUser",
			    //表格显示条纹
			    striped: false,
			    //启动分页
			    pagination: true,
        ...
        function timeBanner() {
            ...
            $('#table_list').bootstrapTable('refresh', { url: '${pageContext.request.contextPath}/admin/listFlockUser?startTimeis=' + startTimeis +'&endTimeis='+endTimeis});
        ...
        function reset() {
            var startTimeis = $('#startTimeis').val('');
            var endTimeis = $('#endTimeis').val('');
            $('#table_list').bootstrapTable('refresh', { url: '${pageContext.request.contextPath}/admin/listFlockUser'});
        }
