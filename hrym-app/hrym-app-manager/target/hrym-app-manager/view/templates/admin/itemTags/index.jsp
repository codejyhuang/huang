    ...
    <script>
        $(document).ready(function () {
			...
			$("#table_list").bootstrapTable({
			    ...
			    //获取数据的Servlet地址
			    url: "${pageContext.request.contextPath}/admin/findAllTags",
			    //表格显示条纹
			    striped: false,
			    //启动分页
			    pagination: true,
               ...
               // height: tableHeight(),
			    ...
			    columns: [{
                    ...
                    formatter: function (value, row, index) {
                    	var operateHtml = '<button class="btn btn-primary btn-xs" type="button" onclick="edit(\''+row.tagId+'\')"><i class="fa fa-edit"></i>&nbsp;编辑</button> &nbsp;';
                    	operateHtml = operateHtml + '<button class="btn btn-danger btn-xs" type="button" onclick="del(\''+row.tagId+'\')"><i class="fa fa-remove"></i>&nbsp;删除</button> &nbsp;';
                        return operateHtml;
                    }
			    }]
			});
        ...
        function queryParams(params){
            ...
            function edit(id) {
                layer.open({
                    ...
                    shade: false,
                    area: ['893px', '500px'],
                    content: '${pageContext.request.contextPath}/view/templates/admin/itemTags/form.jsp?id='+id,
                    end: function (index) {
        ...
        function add(){
            layer.open({
                ...
                shade: false,
                area: ['793px', '500px'],
                content: '${pageContext.request.contextPath}/view/templates/admin/itemTags/form.jsp',
                end: function(index){
                    $('#table_list').bootstrapTable("refresh");
                }
            });
        ...
        function del(id){
        	layer.confirm('确定删除吗?', {icon: 3, title:'提示'}, function(index){
        		$.ajax({
                    ...
                    dataType: "json",
                    contentType: "application/json",
                    url:"${pageContext.request.contextPath}/admin/deleteResourceTagById/",
                    data:{"tagId":id},
