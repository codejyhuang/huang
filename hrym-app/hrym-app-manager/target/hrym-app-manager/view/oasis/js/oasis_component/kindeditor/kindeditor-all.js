...
KindEditor.plugin('baidumap', function(K) {
	...
	self.clickToolbar(name, function() {
		...
		var dialog = self.createDialog({
			...
			yesBtn : {
				...
				click : function(e) {
					...
					// FHMap doesn't support static image of map
					//var url = [checkbox[0].checked ? self.pluginsPath + 'fhmap/index.html' : 'http://api.map.baidu.com/staticimage',
					var url = [self.pluginsPath + 'fhmap/index.html',
		...
		var div = dialog.div,
			...
			win, doc;
		var iframe = K('<iframe class="ke-textarea" frameborder="0" src="' + self.pluginsPath + 'fhmap/map.html" style="width:' + mapWidth + 'px;height:' + mapHeight + 'px;"></iframe>');
		function ready() {
...
// Use the swfupload_loaded_handler event setting to execute customVO code when SWFUpload has loaded.
