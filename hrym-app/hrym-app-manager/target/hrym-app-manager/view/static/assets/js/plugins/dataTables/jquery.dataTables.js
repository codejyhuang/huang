...
(/** @lends <global> */function( $ ) {
	...
	/**
	 * Apply customVO filtering functions
	 *  @param {object} oSettings dataTables settings object
	 *  @memberof DataTable#oApi
	 */
	...
	function _fnFilter( settings, input, force, regex, smart, caseInsensitive )
	{
		...
		// Need to take account of customVO filtering functions - always filter
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		 ...
		 * the web- browser. No customVO sizes can be set in order for this to happen,
		 * nor scrolling used
		 */
		...
		else
		{
			...
			// Apply customVO sizing to the cloned header
	...
	function _fnSortData( settings, idx )
	{
		...
		for ( var i=0, ien=settings.aoData.length ; i<ien ; i++ ) {
			...
			if ( ! row._aSortData[idx] || customSort ) {
				cellData = customSort ?
					customData[i] : // If there was a customVO sort function, use data from there
	...
	function _fnLoadState ( oSettings, oInit )
	{
		...
		/* Allow customVO and plug-in manipulation functions to alter the saved data set and
	 ...
	 *      oSettings
	 *  @param {string} event Name of the jQuery customVO event to trigger. If null no
	 *      trigger is fired
	...
	DataTable.models.oColumn = {
		 ...
		 * afnSortData the customVO sorting will use - if any is defined.
		 *  @type string
		 *  @default std
		 */
		"sSortDataType": 'std',
	...
	DataTable.defaults = {
		 ...
		 * example with a customVO Ajax call.
		 *  @type array
		 *  @default null
		 *
		 *  @dtopt Option
		 ...
		 * request - for example customVO filtering information, and this callback
		 ...
		 * this to a customVO setting using a pop-up menu.
		 *  @type int
		 *  @default 10
		 *
		 *  @dtopt Options
		...
		"oLanguage": {
			 ...
			 * with a customVO select box if required.
			 *  @type string
		 ...
		 * table). DIV elements (with or without a customVO class) can also be added to
	...
	DataTable.ext = _ext = {
		 ...
		 *
		 *  @example
		 *    // The following example shows customVO search being applied to the
		...
		/**
		 * Ordering plug-ins - customVO data source
		 *
		...
		type: {
			 ...
			 * customVO sorting, but it can also be used to provide customVO searching
	 ...
	 *
	 *  @example
	 *     // Use a customVO property returned from the server in another DOM element
