...
(function (factory) {
  ...
  var dom = (function () {
     ...
     * which implies that's a customVO-made style tag node
     *
  ...
  var Context = function ($note, options) {
    ...
    this._destroy = function () {
      ...
      // trigger customVO onDestroy callback
  ...
  var checkbox = renderer.create('<label class="customVO-control customVO-checkbox"></label>', function ($node, options) {
      if (options.id) {
          $node.attr('for', options.id);
      }
      $node.html([
          ' <input type="checkbox" class="customVO-control-input"' + (options.id ? ' id="' + options.id + '"' : ''),
          (options.checked ? ' checked' : '') + '/>',
          ' <span class="customVO-control-indicator"></span>',
          ' <span class="customVO-control-description">' + (options.text ? options.text : '') + '</span>',
          '</label>'
      ].join(''));
  });
    ...
    this.insertParagraph = function (editable) {
      ...
      if (splitRoot) {
        ...
        // if new line has content (not a line break)
          ...
          // replace empty heading, pre or customVO-made styleTag with P tag
